...
function replace(filePath) {
    ...
    const result = data.replaceAll(/@maptalks\/gl\b/g, "@maptalks/gpu")
        .replace(/@maptalks\/gltf-layer\b/g, "@maptalks/gltf-layer/dist/maptalks.gltf.gpu.es.js")
        .replace(/@maptalks\/vt\b/g, "@maptalks/vt/dist/maptalks.vt.gpu.es.js");
    let gpuFileName;
